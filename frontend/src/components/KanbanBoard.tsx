...
export const KanbanBoard = () => {
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <main className="relative mx-auto flex min-h-screen max-w-[1800px] flex-col gap-8 px-6 pb-16 pt-8">
        ...
        <div className="grid items-start gap-6 xl:grid-cols-[minmax(0,1fr)_340px]">
          ...
          >
            <div className="overflow-x-auto pb-4">
              <section className="grid min-w-[1000px] grid-cols-5 gap-5">
                {board.columns.map((column) => (
                  <KanbanColumn
                    key={column.id}
                    column={column}
          ...
          {userId ? (
            <ChatSidebar userId={userId} onBoardUpdate={setBoard} />
          ) : null}
        </div>
      </main>
    </div>
